...
$APPLICATION->SetPageProperty("title", "Гарантия, гарантийное обслуживание ТСК Дипломат");
...
<p>Вся информация на сайте, касающаяся технических характеристик, наличия на складе и стоимости товаров носит информационный характер. </p><?require($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php");?>