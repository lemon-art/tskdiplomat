					...
					?><ul><?
						...
						foreach ($arItem["ITEMS"] as $key => $arSubItem):
							...
							if ($arSubItem["IS_PARENT"]):
								?><li class="<?if ($arSubItem["SELECTED"]):?>selected<?endif?><?if ($bFirst):?> first<?endif?>"><a href="<?=$arSubItem["LINK"]?>"><?=htmlspecialcharsbx($arSubItem["TEXT"])?></a><?
								?><ul><?
							else:
								if ($arSubItem["PERMISSION"] > "D"):
									?><li class="<?if ($arSubItem["SELECTED"]):?>selected<?endif?><?if ($bFirst):?> first<?endif?>"><a href="<?=$arSubItem["LINK"]?>"><?=htmlspecialcharsbx($arSubItem["TEXT"])?></a></li><?
								endif;
							endif;
