...
?>
		<? if ($arItem['DEPTH_LEVEL'] > 1 && !$childSelected && $bHasSelected) :  // if child is selected, but his children are not selected?>
			<li class="current selected lvl<?=$arItem['DEPTH_LEVEL']?>">
				<span style="position:relative; display: block;"><a href="<?=$arItem["LINK"]?>"><?=htmlspecialcharsbx($arItem["TEXT"])?></a><?if ($wizTemplateId == "eshop_vertical"):?><span class="showchild_menu_<?=$curRand?> showchild"><span class="arrow"></span></span><?endif?></span>
			<ul>
		...
		<? else:?>
			...
			<li<?=$className ? ' class="'.$className.'"' : ''?>>
				<span style="position:relative; display: block;"><a href="<?=$arItem["LINK"]?>"><?=htmlspecialcharsbx($arItem["TEXT"])?></a><span class="showchild_menu_<?=$curRand?> showchild<?if ($wizTemplateId == "eshop_vertical_popup"):?>_popup<?endif?>"><span class="arrow"></span></span></span>
...
?>
			<li<?=$className ? ' class="'.$className.'"' : ''?>>
				<span style="position:relative; <?if ($wizTemplateId == "eshop_vertical"):?>display: block;<?endif?>"><a href="<?=$arItem["LINK"]?>"><?=htmlspecialcharsbx($arItem["TEXT"])?></a></span></li><?
			endif;
		endif;
