...
$MESS["wiz_site_sol_folder"] = "The solution will be saved in #SITE_DIR#";
$MESS["wiz_site_id_site_folder_error"] = "The solution cannot be installed to the site root. Please select the solution destination directory.";
$MESS["wiz_site_no_store_error"] = "The mobile web store can be installed if only the e-Store solution is installed. Please install the e-Store solution first.";
?>