<?if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();?>
	...
	<td style="border-collapse: collapse;border-spacing: 0;padding: 0;text-align: left;vertical-align: middle;width: 50%;">
		<img height="67" width="77" src="/bitrix/templates/mail_user/images/right-cloud.png" alt="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;display: inline-block;vertical-align: middle;">
	</td>
</tr>
<tr>
	<td style="border-collapse: collapse;border-spacing: 0;padding: 0;vertical-align: middle;"></td>
	<td align="center" valign="middle" style="border-collapse: collapse;border-spacing: 0;padding: 44px 0 50px;vertical-align: middle;width: 693px;"><?
