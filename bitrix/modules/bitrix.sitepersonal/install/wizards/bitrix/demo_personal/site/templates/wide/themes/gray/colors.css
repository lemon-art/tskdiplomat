...
#header { background: #6E6E6E url(images/top-sprite.png) repeat-x; }

#top-menu a { background: url(images/top-menu-sprite.gif) no-repeat right -54px; color:white;}
#top-menu a:hover { background: #808080 url(images/top-menu-sprite.gif) no-repeat right -105px; }
...
#top-menu li.selected a { background: #FFCE38 url(images/top-menu-sprite.gif) no-repeat right top; color: #404040;}
#top-menu li.selected span { background: url(images/top-menu-sprite.gif) no-repeat left top; }

#site-name a, #site-name a:hover { color: white; text-shadow: 1px 1px 1px #878787; }

#search-layer { background: #4D4D4D url(images/top-sprite.png) repeat-x 0 -156px; }
#search-button input { 	background:#728FCE url(images/search-button.gif) no-repeat; color: white; }

#rss-link { color: #CACACA;}

#content-wrapper { background: transparent url(images/top-sprite.png) repeat-x 0 -196px; }

#user-menu, #user-menu-wrapper b {background-color: #FBFAF4;}
#user-menu-wrapper .r0, #user-menu-wrapper .r2 { border-color: #FCFCF8; }
#user-menu li { border-color: #F1F0EA;}
...
div.sidebar-box-header { background: #F0EFE2 url(images/sidebar-header.gif) repeat-x; color: #000; }
div.sidebar-box-content, div.sidebar-box b {background-color: #f9f7ea;}
div.sidebar-box .r0, div.sidebar-box .r2 { border-color: #FEFEFC; }
...
/* Pop-ups*/
div.bx-dialog-container-wrapper  { background-color: #8A8A8A;}
...
{
	background: #EBEBEB url(images/paging-bg.png) repeat-x; 
	color: #191919;
	border-color: #DEE5EB #C3CBD2 #C3CBD2 #DEE5EB;
}
span.nav-current-page  
{
	background: #FFDC99 url(images/paging-bg.png) repeat-x left -66px; 
	border-color: #EBE5DA #D2CBBD #D2CBBD #EBE5DA;
	color: #191919;
}
div.navigation span.disabled { color:#B2B2B2; }
div.navigation span.arrow { color:#B2B2B2; }
div.navigation span.ctrl { color:#B2B2B2;}

/* Content Block List */
dl.block-list dt { color: #7D7D7A; }
...
div.search-sorting b { background: #FFDC99; }
