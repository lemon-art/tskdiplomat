...
#top-menu a:hover { background: #5391BD url(images/top-menu-sprite.gif) no-repeat right -105px; }
...
#top-menu li.selected a { background: #F4F4F4 url(images/top-menu-sprite.gif) no-repeat right top; color: #084F82;}
