...
<div id="basket_items_list">
												...
												?>
													<td id="basket_quantity_control">
														<div class="basket_quantity_control">
															<a href="javascript:void(0);" class="plus" onclick="setQuantity(<?=$arItem["ID"]?>, <?=$arItem["MEASURE_RATIO"]?>, 'up', <?=$useFloatQuantityJS?>);"><i class="fa fa-sort-asc"></i></a>
															<a href="javascript:void(0);" class="minus" onclick="setQuantity(<?=$arItem["ID"]?>, <?=$arItem["MEASURE_RATIO"]?>, 'down', <?=$useFloatQuantityJS?>);"><i class="fa fa-sort-desc"></i></a>
														</div>
													</td>
												<?
												endif;
	...
	<div class="bx_ordercart_order_pay">
		...
		<div class="bx_ordercart_order_pay_center">
			...
			<?endif;?>
                    <?if ($arResult["allSum"] > 2000):?>
			<button id='checkout' onclick="yaCounter22073026.reachGoal('orderMake1');ga('send', 'event', 'orderMake1', 'submit', 'Оформить заказ в корзине'); checkOut();" class="checkout"><?=GetMessage("SALE_ORDER")?></button>
			<div id='checkout_span' class="disp">Минимальная сумма заказа 2000 руб.</div>
<?else:?>
			<button id='checkout' disabled="" onclick="yaCounter22073026.reachGoal('orderMake1');ga('send', 'event', 'orderMake1', 'submit', 'Оформить заказ в корзине'); checkOut();" class="checkout disabled"><?=GetMessage("SALE_ORDER")?></button><br/>
			<div id='checkout_span'>Минимальная сумма заказа 2000 руб.</div>
                    <?endif;?>    
		</div>
	</div>
</div>
