...
?><ul class="bx_catalog_list_home col<? echo $arParams['LINE_ELEMENT_COUNT']; ?> <? echo $templateData['TEMPLATE_CLASS']; ?>"><?
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?><li class="<? echo ($arItem['SECOND_PICT'] ? '' : 'bx_catalog_item'); ?>"><div class="ajax_block_product" id="<? echo $strMainID; ?>">
	...
	?><div class="product_link"><a style="color: #fe8900;" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<? echo $arItem['NAME']; ?>"><? echo $arItem['NAME']; ?></a></div>
	<div class="bx_catalog_item_price"><div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_price" style="font-size:17px;"><?
	...
	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
	{
		...
		if ($arItem['CAN_BUY'])
		{
			...
			{
			?>
		<div class=""><div style="display: inline-block;position: relative;">
			...
			?>
		<div class="">
			<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="exclusive ajax_add_to_cart_button" href="javascript:void(0)" rel="nofollow"><?
		...
		{
			?><div class=""><span class="bx_notavailable"><?
