...
<li id="user_info">
	Здравствуйте, <span>Гость </span>
(&nbsp;<a class="login_logout" href="<?=$arResult["AUTH_URL"]?>">войти</a>&nbsp;)
&nbsp;
	<span id="your_account">
		<a href="<?=$arResult['PROFILE_URL']?>" title="Ваш счет">Ваш счет</a>
	</span>
</li>
<?else:?>

<li id="user_info">
	Здравствуйте, <span><?=(strlen($arResult["USER_NAME"]) > 0)?$arResult["USER_NAME"]:$arResult["USER_LOGIN"];?> </span>
(&nbsp;<a class="login_logout" href="<?=$APPLICATION->GetCurPageParam("logout=yes", Array("logout"))?>">выйти</a>&nbsp;)
&nbsp;
	<span id="your_account">
		<a href="<?=$arResult['PROFILE_URL']?>" title="Ваш счет">Ваш счет</a>
	</span>
