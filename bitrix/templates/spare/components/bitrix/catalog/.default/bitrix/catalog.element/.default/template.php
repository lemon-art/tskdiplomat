...
$APPLICATION->SetPageProperty("title", $arResult['NAME']." - 1купить  в интернет-магазине TSK DIPLOMAT" );
...
<p><b>Бренд:</b> <? echo $arResult["PROPERTIES"]["MANUFACTURER"]["NAME"]; ?>
<? } ?>
<? } else { ?>
...
<p id="add_to_cart">
<a class="exclusive" href="<?=$arResult["ADD_URL"]?>">Купить</a>
...
<div id="more_info_block">
	<ul id="more_info_tabs" class="idTabs idTabsShort ">
		<li><a class="selected" id="more_info_tab_more_info" href="#idTab1">1Описание</a></li> 
