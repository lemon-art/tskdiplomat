...
<h4><?=GetMessage("CR_TITLE_".$arParams["FLAG_PROPERTY_CODE"])?></h4>
...
<div>
<input value="В корзину" type="button" class="exclusive ajax_add_to_cart_button" onclick="yaCounter22073026.reachGoal('toBasketMorda');ga('send', 'event', 'toBasketMorda', 'submit', 'В корзину на главной');" rel="ajax_id_product_<?=$arItem["ID"]?>" title="В корзину">
</div>
</li>
