...
<p id="add_to_cart">
<!--<a class="ajax_add_to_cart_button exclusive" rel="ajax_id_product_<?=$arResult["ID"]?>" href="<?=$arElement["ADD_URL"]?>" onclick="yaCounter22073026.reachGoal('buyFromDetail');ga('send', 'event', 'buyFromDetail', 'submit', 'Купить в карточке товаров');">Купить</a>-->
<a class="exclusive" href="<?=$arElement["ADD_URL"]?>" onclick="yaCounter22073026.reachGoal('buyFromDetail');ga('send', 'event', 'buyFromDetail', 'submit', 'Купить в карточке товаров');">Купить</a>
