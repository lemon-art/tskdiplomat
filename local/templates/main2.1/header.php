                        ...
                        -->
                            <div class="header">
                                    <div class="header-buttons">
                                        <div class="header-button top-about">
                                        ...
                                        <div class="header-button menu-list">
                                            ...
                                            <ul class="links">
                                                <li>
                                                    <a href="/customer/account/" title="My Account">Мой счет</a>
                                                </li>
                                                <li><a href="/checkout/cart/" title="My Cart" class="top-link-cart">Корзина</a></li>
                                                <li><a href="/checkout/" title="Checkout" class="top-link-checkout">Заказы</a></li>
                                                <li><a href="/wishlist/" title="My Wishlist">Избранное</a></li>
                                            </ul>
                                        </div>
                                        <div class="header-button top-auth">
                                            ...
                                            if ($USER->IsAuthorized()) {
                                                ?>
                                                <a  class="sign-out" href="/?logout=yes" title="Выйти">
                                                    <i class="fa fa-sign-out"></i>
                                                    <span>Выход</span>
                                                </a>
                                            <? } else { ?>
                                                <a class="sign-in" href="/auth/" title="Войти на сайт">
