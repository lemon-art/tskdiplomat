...
//    $APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/css/print.css"); needet media
    ...
    $APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH."/js/jquery-1.7.min.js");
    ...
    $APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH."/js/jquery.mobile.customized.min.js");
...
<?$APPLICATION->ShowPanel(); ?>
                    <div class="wrapper en-lang-class">
                        ...
                        <div class="page">
                                            ...
                                            <div class="header">
                                                <div class="header-buttons">
                                                    <div class="header-button top-login">
                                                        <ul class="links">
                                                            <li>
                                                                <a href="/auth/" title="Log In" class="Login_link">Log In</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                            ...
                            ?>
                            <div class="main-container <?=$mainContainerClass;// $APPLICATION->GetProperty('PAGE_LAYOUT');?>">
                                <div class="container">
                                    <div class="row">
                                        <div class="span12">
                                            <div class="main">
