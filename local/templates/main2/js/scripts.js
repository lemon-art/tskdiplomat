jQuery(document).ready(function(){
	...
	/*********************************************************************************************************** Footer Accordion *********************************************************************/
		jQuery('.footer .footer-col > span').append('<span class="toggle"></span>');
		jQuery('.footer span.footer-col-title').on("click", function(){
   ...
   jQuery('.map-popup-close').on('click',function(){ 
	...
	/*********************************************************************************************************** Header Cart *********************************************************************/
        ...
        jQuery('.cat-text .cat-text-opener').on('click',function(){
            ...
            console.log(jQuery(this).parent('.cat-text'))
    ...
    /* back call */
    jQuery("#ModalBackCall button[type='submit']").on('click',function(e){
        e.preventDefault();
        jQuery('#ModalBackCall').addClass('send');
        jQuery.ajax({
            url: '/local/ajax/back-call.php',
            data: jQuery('#form-back-call').serialize(),
            method: 'POST',
            dataType: 'json',
        }).success(function(response) {
            if(response.STATUS == 'OK'){
                jQuery('#ModalBackCall .result-message').html(response.MESSAGE);
                jQuery('#ModalBackCall').addClass('sendet').removeClass('send');
                jQuery("#ModalBackCall button[type='submit']").addClass('disabled');
            }else{
                jQuery('#ModalBackCall').removeClass('send');
                if(response.STATUS == 'ERROR'){
                    jQuery('.form-group').removeClass('error');
                    jQuery.each(response.ERROR,function(field, message){
                        jQuery('#'+field +' .error_msg').html(message);
    ...
    jQuery('.get-call-back').click(function(e){
        e.preventDefault();
