...
//redirect dubles to main section
?>
<!-- arResult
<?//trace($arResult)?>
-->
<?
//$rs = CIBlockElement::GetElementGroups($ELEMENT_ID, true);
//while($ar )

$APPLICATION->SetPageProperty("PAGE_LAYOUT","col2-right-layout");
...
?>
                                    ...
                                    <div class="col-right sidebar col-md-3">
                                        ...
                                        <? if (count($GLOBALS['DETAIL_LINKED_ELEMENTS']) > 0): 
                                            $GLOBALS['arrRelatedFilter'] = array('ID' => $GLOBALS['DETAIL_LINKED_ELEMENTS']);
                                        ?>
                                            <div class="block block-related">
                                                <div class="block-title">
                                                    <strong><span><?=GetMessage('TPL_RELATED_BLOCK_TITLE')?></span></strong>
                                                </div>
                                                <div class="block-content">
                                                    <!--
                                                    <p class="block-subtitle"><?=GetMessage('TPL_RELATED_SELECT_DESC')?>&nbsp;<a href="#" onclick="selectAllRelated(this);
                                                    
                        return false;"><?=GetMessage('TPL_RELATED_SELECT_ALL')?></a></p>
                                                    -->
<?$APPLICATION->IncludeComponent(
	"bitrix:catalog.top",
	"related",
