...
<?}else{?>
    <hr/><a name="products"></a>
<?}?>
<div class="row brand-products">
    <div class="col-md-3">
        <span class="catalog-all-sections">
            <a href="<?=$APPLICATION->GetCurPageParam('',array('SECTION','PAGEN_2'))?>" >Все разделы</a>
        </span>
<?
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"VIEW_MODE" => "LINE",
		"SHOW_PARENT_NAME" => "N",
		"SECTION_URL" => $APPLICATION->GetCurPageParam('SECTION=#SECTION_CODE##products',array('SECTION','PAGEN_2')),
		"CACHE_TYPE" => "A",
		"CACHE_TIME" => "36000000",
		"CACHE_GROUPS" => "N",
