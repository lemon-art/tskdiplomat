...
<?    switch ($pageLayOut):
        case 'col2-left':?>
		<div class="col-left sidebar col-lg-3 col-sm-3">
<?/*$APPLICATION->IncludeComponent(
	...
	false
            ...
            <?break;
        case 'col2-right':?>
                                    <div class="col-right sidebar col-lg-3 col-sm-3">
                                       		<?/*$APPLICATION->IncludeComponent(
							"bitrix:main.include",
							"",
							Array(
...
<!-- footer -->                            
                                            ...
                                            <div class="footer">
                                                ...
                                                <div class="footer-cols-wrapper">
                                                    <div class="footer-col">
                                                        <span class="footer-col-title"><?=GetMessage('TPL_FOOTMT_ABOUT_SHOP')?></span>
		...
		<?$APPLICATION->IncludeComponent("bitrix:menu", "bl", array(
			...
			false
                                                    ...
                                                    <div class="footer-col middle">
                                                        <span class="footer-col-title"><?=GetMessage('TPL_FOOTMT_ABOUT_BUY')?></span>
                                                        <div class="footer-col-content">
		<?$APPLICATION->IncludeComponent("bitrix:menu", "bl", array(
			...
			false
                                                    ...
                                                    <div class="footer-col">
                                                        <span class="footer-col-title"><?=GetMessage('TPL_FOOTMT_ACCAUNT')?></span>
                                                        <div class="footer-col-content">
		<?$APPLICATION->IncludeComponent("bitrix:menu", "bl", array(
			...
			false
                                                    ...
                                                    <div class="footer-col last contacts">
                                                        <span class="footer-col-title"><?=GetMessage('TPL_FOOTMT_CONTACTS')?></span>
                                                        <div class="footer-col-content">
        ...
        <div><!-- /body wrap -->  
        <?$APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_TEMPLATE_PATH."/includes/modals/backcall.php"), false);?>
</body>
</html>