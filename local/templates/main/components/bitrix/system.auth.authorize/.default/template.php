                ...
                <div class="new-users-wrapper">
                    <div class="col-1 new-users">
                        <div class="content">
                            ...
                            <div class="buttons-set">
                                <button type="button" title="<?=GetMessage('AUTH_REGISTER_TITLE');?>" class="button" onclick="window.location = 'http://livedemo00.template-help.com/magento_46246/customer/account/create/';">
                                    <span>
                                        <span>
